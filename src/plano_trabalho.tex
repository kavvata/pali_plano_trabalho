...
Embora essas ferramentas viabilizem a gestão de dados, os entraves apontados questionam sua real eficiência em poupar tempo e esforço dos pesquisadores. Desconsiderar a experiência do usuário durante o desenvolvimento pode resultar no abandono da plataforma \cite{michener_participatory_2012}.
...
\section{OBJETIVO}
O trabalho proposto tem por objetivo geral o desenvolvimento de um sistema para registro de comunidades ecológicas marinhas e estuarinas, visando investigar a eficácia do sistema em agilizar o processo de coleta e análise de dados dessas comunidades. Dessa forma, os objetivos específicos são:
\begin{itemize}
