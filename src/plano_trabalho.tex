...
Para que a solução projetada se ajuste a esse trabalho real, utilizam-se duas técnicas de representação do usuário: as personas e o mapa de empatia \cite{siricharoen_using_2021}. O mapa de empatia sintetiza os dados da pesquisa organizando-os em torno do que o usuário pensa, sente, vê, ouve e faz, de modo que a equipe compreenda a experiência e as intenções dos usuários sem depender apenas do registro de seus comportamentos. A persona, por sua vez, expressa as necessidades de design por meio de um perfil arquetípico construído a partir de dados empíricos, fazendo com que o usuário seja tratado como uma personagem coerente, em vez de um conjunto de especificações, o que facilita a comunicação das decisões de design. Os dois conceitos se complementam: o mapa de empatia identifica usuários com diferentes intenções e fornece as evidências que fundamentam a construção das personas, e a persona consolida essas evidências em um referencial estável que orienta o projeto; na estrutura do DT, as personas são descobertas na fase de definição, à qual a fase de empatia precede e orienta \cite{siricharoen_using_2021}.
