...
No entanto, o caminho para atingir tais resultados não é necessariamente simples. Segundo \citeonline{strasser_promoting_2011}, esse processo pode ser compreendido como um ``ciclo de vida'' de dados, o qual compreende desde a coleta e organização dos dados até a sua descrição e depósito em um sistema repositório, englobando a preservação de longo prazo e culminando na descoberta, integração e análise dessas informações. <Encontrar exemplo>
