...
Operacionalmente, a pesquisa segue o processo iterativo do \textit{Design Thinking} \cite{brown_design_2021}, cuja estrutura -- empatia, definição, ideação, prototipação e teste -- organiza o passo a passo descrito a seguir em oito etapas, detalhadas na sequência.

\begin{enumerate}
\item Empatia. Serão realizadas entrevistas semiestruturadas com pesquisadores de grupos de pesquisa que atuam no registro de comunidades ecológicas marinhas e estuarinas selecionados por amostragem de conveniência. A participação será voluntária, mediante assinatura de Termo de Consentimento Livre e Esclarecido, com garantia de anonimato na análise dos relatos. O objetivo é compreender o fluxo de trabalho atual de coleta, triagem e identificação de táxons, abordando tanto o manuseio das amostras, a inclusão dos dados em planilhas até a análise desses dados. As entrevistas serão gravadas e transcritas, e as transcrições serão submetidas a análise temática: após a familiarização com os dados, gera-se um conjunto de códigos, a partir dos quais se constroem, revisam e definem os temas centrais. O produto da etapa é um relatório de contexto organizado por temas, que mapeia as tarefas, as ferramentas e as dificuldades do método manual.

\item Definição. A análise temática das entrevistas, conduzida na etapa anterior, orienta a definição de personas -- perfis arquetípicos dos pesquisadores usuários do sistema -- e a criação de um mapa de empatia, no qual se registram o que os usuários pensam, sentem, veem, ouvem e fazem, bem como suas dores e ganhos. A partir dessas evidências, formula-se o Point of View (POV) -- síntese do problema, combinando a necessidade do usuário, o insight observado e o critério de sucesso. O produto da etapa é o conjunto de artefatos de definição -- personas, mapa de empatia e POV --, que direciona a ideação de soluções.

\item Linha de base (pré-teste). Antes do desenvolvimento, registra-se o desempenho com o método manual atual: os mesmos pesquisadores executam as mesmas tarefas de triagem e identificação de táxons, medindo-se o tempo despendido por tarefa, a taxa de acerto na identificação e a carga de trabalho mental por meio do NASA-TLX \cite{hart_development_1988}. O produto da etapa é o conjunto de dados de linha de base, referência para a comparação posterior.

\item Ideação. Com base nos artefatos de definição, geram-se alternativas de solução para o registro e a triagem taxonômica, que são avaliadas com os participantes quanto à aderência ao fluxo de trabalho observado. O produto da etapa é a alternativa de solução selecionada, com o escopo funcional inicial do sistema.

\item Definição de requisitos. A partir da alternativa selecionada, consolidam-se os requisitos funcionais e não funcionais do sistema, aplicando técnicas de engenharia de requisitos: levantamento, análise, priorização e especificação. O produto da etapa é o documento de requisitos, que define o escopo da funcionalidade de triagem taxonômica a ser desenvolvida.

\item Prototipação e teste. A alternativa é desenvolvida de forma incremental, seguindo práticas de engenharia de software -- especificação, implementação iterativa e verificação --, e protótipos parciais são testados com os participantes, incorporando-se os ajustes identificados. O produto da etapa é a versão estável do sistema, pronta para a avaliação formal.

\item Pós-teste. Os mesmos pesquisadores executam novamente as mesmas tarefas de triagem e identificação de táxons, agora utilizando o sistema desenvolvido. Medem-se a eficácia e a eficiência do uso, segundo os construtos da ISO 9241-11 \cite{iso9241_11_2018}, e a carga de trabalho mental por meio do NASA-TLX, em condições equivalentes às da linha de base. O produto da etapa é o conjunto de dados de pós-teste, comparável ponto a ponto com os dados de pré-teste.

\item Análise dos resultados. Os dados obtidos antes e depois da intervenção são comparados por meio de estatística descritiva e de testes de comparação de amostras pareadas -- teste \textit{t} de Student pareado ou teste de Wilcoxon, conforme a distribuição verificada por teste de normalidade --, de modo a avaliar a significância estatística das diferenças observadas no tempo de tarefa, na taxa de acerto e na carga de trabalho mental. O produto da etapa é a análise que confronta os resultados com os objetivos específicos da pesquisa.
